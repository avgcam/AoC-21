...
def part1():
    ...
    while len(scanners) > 0:
        ...
        del scanners[s]
        scanner_position.append(trams)

    print('Part1 Answer: ', len(grid))
    return scanner_position

def part2(x):
    print('Part2 Answer: ', max([distance_taxi(c[0],c[1]) for c in combinations(x,2)]))

if __name__ == "__main__":
    scanner_posistion = part1()
    part2(scanner_posistion)